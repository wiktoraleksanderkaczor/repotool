...
public record TypeInfoComponent
{
    ...
    /// </code>
    /// </example>
    public required List<EnTypeInfoModifierFlag> ModifierFlags { get; init; }
    ...
    public string GetUniqueName()
    {
        ...
        sb.Append(GetGenericArgumentString());
        return sb.ToString();
    }
        ...
        if ( GenericArguments != null && GenericArguments.Count > 0 )
        {
            ...
            if ( GenericArguments.Count > 0 )
            {
                ...
                foreach ( TypeInfoDefinition genericArgument in GenericArguments )
                {
                    ...
                    sb.Append(genericArgument.Type.GetUniqueName());
                    first = false;
                }
            }
            sb.Append('>');
...
public record GenericConstraintInfo
{
    ...
    /// </code>
    /// </example>
    public required List<EnGenericConstraintTypeFlag> ConstraintFlags { get; init; }
}
