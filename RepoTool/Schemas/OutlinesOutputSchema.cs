...
namespace RepoTool.Schemas
{
    ...
    public static class OutlinesOutputSchema
    {
        ...
        /// </summary>
        /// <returns>A configured <see cref="JsonSchemaBuilder"/> instance representing the Outlines meta-schema.</returns>
        public static JsonSchemaBuilder CreateSchemaBuilder()
        {
            ...
            // Define the allowed types for the 'type' keyword in an Outlines schema
            ...
            JsonSchemaBuilder metaSchemaBuilder = new JsonSchemaBuilder()
                ...
                .Id("https://localhost/outlines-structured-output-meta-schema")
                .Title("Outlines Structured Output Meta-Schema")
                .Type(SchemaValueType.Object)
                .Properties(
                    ("$schema", new JsonSchemaBuilder().Const("https://localhost/outlines-structured-output-meta-schema")),
                    ("type", typeSchema),
        ...
        /// </summary>
        /// <returns>A <see cref="JsonSchema"/> instance representing the Outlines meta-schema.</returns>
